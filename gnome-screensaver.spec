...
# http://bugzilla.redhat.com/677580
Patch15: add-kbd-layout-chooser-back.patch

# http://bugzilla.redhat.com/648850
Patch16: fix-fade-crash.patch

# http://bugzilla.redhat.com/719023
Patch17: fix-bg-on-dock.patch

# http://bugzilla.redhat.com/697892
Patch18: fix-unlock-placement.patch
...
%patch15 -p1 -b .add-kbd-layout-chooser-back
%patch16 -p1 -b .fix-fade-crash
...
* Fri Nov 04 2011 Ray Strode <rstrode@redhat.com> 2.28.3-17
- Fix crash on systems with single keyboard layouts
  Related: #677580,Resolves:751402

* Tue Oct 25 2011 Ray Strode <rstrode@redhat.com> 2.28.3-16
- More monitor dock fixes
  Resolves: #719023 746237
- Potential workaround for libxklavier brokeness
  Related: #677580

* Thu Oct 06 2011 Ray Strode <rstrode@redhat.com> 2.28.3-15
- Fix bug in window placement logic
  Related: #740892
  Resolvess: #743876

* Wed Oct 05 2011 Ray Strode <rstrode@redhat.com> 2.28.3-14
- Fix rare deadlock during monitor reconfiguration
  Resolves: #740892

* Mon Aug 01 2011 Ray Strode <rstrode@redhat.com> 2.28.3-13
- Place unlock dialog on consistent monitor
  Resolves: #697892

* Fri Jul 29 2011 Ray Strode <rstrode@redhat.com> 2.28.3-12
- Fix background on dock action
  Resolves: #719023

* Fri Jul 29 2011 Ray Strode <rstrode@redhat.com> 2.28.3-11
- Fix fade crash on exotic X servers
  Resolves: #648850

* Mon Jul 25 2011 Ray Strode <rstrode@redhat.com> 2.28.3-9
